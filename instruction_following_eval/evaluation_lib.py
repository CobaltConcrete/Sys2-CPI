...
def test_instruction_following_strict(
  ...
  # CHecking
  # print(f"Available prompts: {list(prompt_to_response.keys())[:5]}")
  # print(f"Missing prompt: {inp.prompt}")
  # print(repr(inp.prompt))
  # print([repr(p) for p in prompt_to_response.keys()])
